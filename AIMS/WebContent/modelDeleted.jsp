...
<center>
<%
String model_deleted="";
String mid=request.getParameter("model1");
if(mid.equals("none"))
{
	out.println("<script type=\"text/javascript\">");
	   out.println("alert('Select model to be deleted.');");
...
while(rs.next())
{
	 model_deleted=rs.getString(3);
}
str="delete from model_master where model_id='"+mid+"'";
stmt.executeUpdate(str);

String str1="insert into liveupdate(description) values('model-"+model_deleted+" deleted')";
stmt.executeUpdate(str1);
%>
<br>
<br>
<center><label><b>MODEL <%=model_deleted%> DELETED</b></label></center>
<br>
<br>
