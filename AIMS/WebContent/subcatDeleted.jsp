...
<%
String subcat_old="";
String sid=request.getParameter("subcat1");
if(sid.equals("none"))
{
	out.println("<script type=\"text/javascript\">");
	   out.println("alert('Select subcategory to be deleted.');");
...
str="delete from subcategorymaster where subcategoryid='"+sid+"'";
stmt.executeUpdate(str);

String str1="insert into liveupdate(description) values('subcategory-"+subcat_old+" deleted')";
stmt.executeUpdate(str1);
%>
<br>
<br>
<center><label><b>SUBCATEGORY <%=subcat_old %> DELETED</b></label>
<br>
<br>
